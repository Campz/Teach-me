...
public class ResultadosAdapter extends RecyclerView.Adapter<ResultadosAdapter.ResultadosHolder> {
    ...
    * */
    ...
    public void onBindViewHolder(@NonNull ResultadosHolder holder, int position) {
        holder.txt_nmProfessor.setText(resultados.get(position).getCdUsuario_Professor().getNmUsuario());
        ...
        holder.txt_avaliacao.setText(resultados.get(position).getCdUsuario_Professor().getAvaliacao());
    }
